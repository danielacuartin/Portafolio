        ...
        <Container>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="ms-auto">
              ...
              <Nav.Link href="#Certificados" className={activeLink === 'Certificados' ? 'active navbar-link' : 'navbar-link'} onClick={() => onUpdateActiveLink('Certificados')}>Certificados</Nav.Link>
            </Nav>
